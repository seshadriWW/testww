...
node {
	...
	if(params.BUILD_MECHANISM == 'BUILD'){
		...
		stage 'Notification'
			SendEmail("seshadri.rayaprolu@whishworks.com","seshadri.rayaprolu@whishworks.com","success")
			
		}catch(error)
		{
			throw(error)
			SendEmail("seshadri.rayaprolu@whishworks.com","seshadri.rayaprolu@whishworks.com","Failed")
		}
